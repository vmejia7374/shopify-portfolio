...
import { tokenpic, schouten } from "../assets";
    ...
    >
      ...
      >
        <div className="relative z-index-[5] h-[90%] w-[85%]">
          <img src={schouten} alt="tokenpic" className="flex w-[480px] h-[480px] object-cover rounded-[50%] border-[10px] border-teal-200"></img>
